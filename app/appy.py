...
openai.api_key = st.secrets["streamlit run app.py"]
...
Blackgpt_footer = f"""
BlackGPT {package_data['version']}, released on {package_data['release_date'].strftime('%B %d, %Y')}. Keep in mind that BlackGPT may produce inaccurate information about people, places, or facts.
"""
